...
<footer class="text-muted py-5">
  <div class="container">
    ...
    <p class="mb-1">&copy; sebastian meliot</p>
    <p class="mb-0">WeFASHION <a href="/">Visit the homepage</a> or read our <a href="/docs/5.2/getting-started/introduction/">getting started guide</a>.</p>
  </div>
</footer>
